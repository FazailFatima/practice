...
<header class="navbar navbar-expand sticky-top" role="navigation">
  <div class="container">
    <a class="navbar-brand navbar-home" href="/app">
      <img class="app-logo" style="width: {{ navbar_settings.logo_width || 50 }}px;max-height:45px "
        src="/assets/velobiotics_ui/images/favicon.png" />
    </a>
  ...
  // ../velobiotics_ui/velobiotics_ui/public/js/ui/toolbar/issue-report.js
  ...
  $(document).on("click", ".showHelpDialog", function() {
    new frappe.views.CommunicationComposer({
      ...
      recipients: "support@velobiotics.com"
    });
  });
})();
//# sourceMappingURL=al_fajr_toolbar.bundle.TMWBZJNB.js.map
