...
<header class="navbar navbar-expand sticky-top" role="navigation">
  <div class="container">
    <a class="navbar-brand navbar-home" href="/app">
      <img class="app-logo" style="width: {{ navbar_settings.logo_width || 50 }}px "
        src="{{ navbar_settings.app_logo || /assets/velobiotics_ui/images/favicon.png }}" />
    </a>
  ...
  $(document).on("click", ".showHelpDialog", function() {
    new frappe.views.CommunicationComposer({
      ...
      recipients: "support@al_fajr.com"
    });
  });
})();
//# sourceMappingURL=toolbar.bundle.AJSKX34S.js.map
